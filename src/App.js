...
// export default function App(){
//   let[isMorn,setMorn] = useState(true)
//   return ( 
//     <div className="change">
//       <h2>{isMorn ? "Morning" : "Night"}</h2>
//       <button onClick={
//         () => setMorn(!isMorn)
//       }>
//         update day
...
//   return (
//     <div>
//       <h1>{isNight ? "Good Night" : "Good Day"}</h1>
//       <button onClick={
//         () => setNight(!isNight)
//       }>
//         Change
...
export default function App(){
  let[isMorn,setMorn] = useState(true)
  return(
    <div className={`${isMorn ? "dayLight" : "nightLight"}`}>
      <h1>Day Time = {isMorn ? "Morning" : "Night"}</h1>
      <button onClick={
        () => setMorn(!isMorn)
      }>
        update
